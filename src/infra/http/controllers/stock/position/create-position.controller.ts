...
import { bodyValidationPipe, CreatePositionBody } from './schemas/create-position-schema';
...
export class CreatePositionController {
  ...
  async handle(@Body(bodyValidationPipe) body: CreatePositionBody, @CurrentUser() user: UserPayload) {
