...
describe('[DELETE] /addressings/:id (E2E)', () => {
  ...
  it('should delete an addressing when user is admin or manager', async () => {
    ...
    const response = await request(app.getHttpServer())
      .delete(`/addressings/${addressing.id.toString()}`)
    ...
    expect(addressingOnDatabase).toBeNull();
  });
});
