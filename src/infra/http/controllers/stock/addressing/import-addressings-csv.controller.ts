...
} from '@/domain/stock/application/use-cases/addressing/import-addressings-csv';
...
export class ImportAddressingsCsvController {
  constructor(private readonly _useCase: ImportAddressingsCsvUseCase) {}
  ...
  async handle(
    ...
    const rows: AddressingCsvRow[] = rawRows.map((r) => ({
      locationCode: r.locationCode,
      subLocationCode: r.subLocationCode,
      rowCode: r.rowCode,
