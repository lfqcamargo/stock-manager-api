...
describe('[DELETE] /movement-types/:id (E2E)', () => {
  ...
  it('should delete a movement type when user is admin or manager', async () => {
    ...
    const response = await request(app.getHttpServer())
      .delete(`/movement-types/${movementType.id.toString()}`)
    ...
    expect(movementTypeOnDatabase).toBeNull();
  });
});
